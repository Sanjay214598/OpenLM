    ...
    Requisitions.update({id: $scope.rnr.id, operation: "save"}, rnr, function (data) {
	  ...
	  var autoRnr = {
			fullSupplyLineItems: [{
				...
				maxStockQuantity: 51,
				newPatientCount: 10,
				normalizedConsumption: 45,
				packRoundingThreshold: 1,
				packSize: 10,
				packsToShip: 1,
				periodNormalizedConsumption: 45,
				previousNormalizedConsumptions: [1, 4],
				previousStockInHand: 1,
				price: 50,
				product: "Phytomenadione (Vitamin K-1) 10mg/ml  injection Capsule 300/200/600 mg",
				productCategory: "Anaesthetics",
				productCategoryDisplayOrder: 4,
				productCode: "P151",
				productDisplayOrder: 3,
				productStrength: "300/200/600",
				quantityApproved: null,
				quantityDispensed: 10,
				quantityReceived: 10,
				quantityRequested: "10",
				reasonForRequestedQuantity: "Automated RNR submission",
				reportingDays: 30,
				rnrId: 7,
				roundToZero: false,
				skipped: false,
		...
		Requisitions.update({id: $scope.rnr.id, operation: "save"}, autoRnr, function (data) {
			deferred.resolve();
